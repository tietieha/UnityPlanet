...
class CSerialzieStream : Stream
{
	...
	void swap_int(int nIntSize, int nPos)
	{
		...
		switch (nIntSize)
		{
			case 2: // [1][2] ==> [2][1]
				yTemp = m_pData[nPos];
				m_pData[nPos] = m_pData[nPos + 1];
				m_pData[nPos + 1] = yTemp;
				break;
			case 4: // [1][2][3][4] ==> [4][3][2][1]
				yTemp = m_pData[nPos];
				m_pData[nPos] = m_pData[nPos + 3];
				m_pData[nPos + 3] = yTemp;
				yTemp = m_pData[nPos + 1];
				m_pData[nPos + 1] = m_pData[nPos + 2];
				m_pData[nPos + 2] = yTemp;
				break;
			case 8: // [1][2][3][4][5][6][7][8] ==> [8][7][6][5][4][3][2][1]
				yTemp = m_pData[nPos];
				m_pData[nPos] = m_pData[nPos + 7];
				m_pData[nPos + 7] = yTemp;
				yTemp = m_pData[nPos + 1];
				m_pData[nPos + 1] = m_pData[nPos + 6];
				m_pData[nPos + 6] = yTemp;
				yTemp = m_pData[nPos + 2];
				m_pData[nPos + 2] = m_pData[nPos + 5];
				m_pData[nPos + 5] = yTemp;
				yTemp = m_pData[nPos + 3];
				m_pData[nPos + 3] = m_pData[nPos + 4];
				m_pData[nPos + 4] = yTemp;
				break;
			default:
				break;
		}
	...
	{
		get { return m_arType == SerializeType.read; }
	}
	...
	{
		get { return m_arType == SerializeType.read || m_arType == SerializeType.append; }
	}
